        ...
        <div className="prose prose-gray max-w-none">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-gray-600 text-sm">
              Our full Cookie Policy is being finalised and will be published here shortly.
          ...
          <p className="text-gray-600 text-sm">
            LandlordShield uses essential cookies to ensure the site functions correctly and
            optional analytics cookies to help us improve the service. Our full policy will detail
            the types of cookies we use, their purpose, and how you can manage your cookie
            preferences.
          </p>
        </div>
      </div>
