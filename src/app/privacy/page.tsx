        ...
        <div className="prose prose-gray max-w-none">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-gray-600 text-sm">
              Our full Privacy Policy is being finalised and will be published here shortly.
              If you have any questions about how we handle your data, please contact us at{' '}
              <a href="mailto:privacy@landlordshield.co.uk" className="text-[#1E3A5F] underline">
          ...
          <p className="text-gray-600 text-sm">
            LandlordShield is committed to protecting your personal data and being transparent about
            how we collect, use, and store your information. Our full policy will cover data
            collection, usage, retention, your rights under UK GDPR, and how to contact our data
            protection officer.
          </p>
        </div>
      </div>
